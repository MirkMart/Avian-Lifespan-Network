...
# *pvalue_complete.tsv files were compiled listing all p-values (6th column) of a TRACCER run appending the type of analysis run (tes_analysis, weight control, or phylogenetic control)
...
#Kolmogorov-Smirnov tests have been perfomed to test if the density distribution of our runs were significantly different.
...
#ECDS. Since Kolmogorov-Smirnov test is used to compare distribution, we decided to represent graphically the comparison.
